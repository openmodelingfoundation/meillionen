...
contains
    subroutine soil_initialize(input) bind(c, name='soil_initialize')
        type(SoilInput) :: input
        call sw(DOY=input%doy, LAI=input%lai, RAIN=input%rain, SRAD=input%srad, &
                TMAX=input%tmax, TMIN=input%tmin, SWFAC1=input%swfac1, &
                SWFAC2=input%swfac2, DYN='INITIAL   ')
    end subroutine soil_initialize

    subroutine soil_rate(input) bind(c, name='soil_rate')
        type(SoilInput) :: input
        call sw(DOY=input%doy, LAI=input%lai, RAIN=input%rain, SRAD=input%srad, &
                TMAX=input%tmax, TMIN=input%tmin, SWFAC1=input%swfac1, &
                SWFAC2=input%swfac2, DYN='RATE      ')
    end subroutine soil_rate

    subroutine soil_integ(input) bind(c, name='soil_integ')
        type(SoilInput) :: input
        call sw(DOY=input%doy, LAI=input%lai, RAIN=input%rain, SRAD=input%srad, &
                TMAX=input%tmax, TMIN=input%tmin, SWFAC1=input%swfac1, &
                SWFAC2=input%swfac2, DYN='INTEG     ')
    end subroutine soil_integ

    subroutine soil_output(input) bind(c, name='soil_output')
        type(SoilInput) :: input
        call sw(DOY=input%doy, LAI=input%lai, RAIN=input%rain, SRAD=input%srad, &
                TMAX=input%tmax, TMIN=input%tmin, SWFAC1=input%swfac1, &
                SWFAC2=input%swfac2, DYN='OUTPUT    ')
    end subroutine soil_output

    subroutine soil_close(input) bind(c, name='soil_close')
        type(SoilInput) :: input
        call sw(DOY=input%doy, LAI=input%lai, RAIN=input%rain, SRAD=input%srad, &
                TMAX=input%tmax, TMIN=input%tmin, SWFAC1=input%swfac1, &
                SWFAC2=input%swfac2, DYN='CLOSE     ')
    end subroutine soil_close
end module SoilFFI